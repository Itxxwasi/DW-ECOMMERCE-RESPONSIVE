...
const brandSectionsRoutes = require('./routes/brand-sections');
...
console.log('DEBUG: Requiring subcategories-public...');
const subcategoriesPublicRoutes = require('./routes/subcategories-public');
console.log('DEBUG: Required subcategories-public successfully');
console.log('DEBUG: subcategoriesPublicRoutes stack:', subcategoriesPublicRoutes.stack.map(r => r.route && r.route.path));
...
app.use('/api/admin/brand-sections', brandSectionsRoutes);
app.use('/api/brand-sections', brandSectionsRoutes);
