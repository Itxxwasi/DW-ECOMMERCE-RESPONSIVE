...
router.get('/', async (req, res) => {
    try {
        ...
        if (categoryId) {
            console.log(`[SUBCATEGORIES API] Fetching subcategories for category: ${categoryId}`);
        ...
        console.log(`[SUBCATEGORIES API] ✓ Found ${subcategories.length} active subcategories${categoryId ? ` for category ${categoryId}` : ''}`);
        ...
        console.error('[SUBCATEGORIES API] ✗ Error fetching subcategories:', err);
